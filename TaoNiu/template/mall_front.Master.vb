Public Class mall_front
    ...
    Public Sub getFunLeft()
        ...
        If Session("onTheWay") <> "loginSuccess" Then
            strWite = "您好，欢迎来到<a href='" & myMain.siteUrl & "'>" & myMain.siteName & "</a>!&nbsp;<a style='color:red;' href='default.aspx'>首页</a>&nbsp;<a href='../login.aspx?redirectURL=mall/index.aspx'>请登录</a>&nbsp;<a href='../reg.aspx'>免费注册</a>"
        Else
