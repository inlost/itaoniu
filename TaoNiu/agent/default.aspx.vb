Public Class _default3
    ...
    Public Sub getShopList()
        Dim shops As Hashtable(), myWeiTuo As New weituo, myShop As New shop, theShop As New Hashtable
        shops = myWeiTuo.getWtShopList(Session("id"))
        If shops(0)("count") < 1 Then Exit Sub
        For Each shop As Hashtable In shops
            theShop = myShop.getShopInfo(shop("shopId"))
            Response.Write("<option value='" & theShop("id") & "'>" & theShop("shop_name") & "</option>")
        Next
    End Sub
