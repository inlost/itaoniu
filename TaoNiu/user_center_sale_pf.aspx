<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/template/user_center.Master" CodeBehind="user_center_sale_pf.aspx.vb" Inherits="TaoNiu.user_center_sale_pf" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentContent" runat="server">
    <div id="operateArea">
        ...
        <div id="tip"><p>在这儿，您可以查看管理您店铺的批发商品。</p></div>
          <h2><span class="subTitle">批发添加</span><span class="subBt"><a href="#"></a></span></h2>
            <div class="infoBox">
                ...
                <form method="post" action="server_page/sale_fun.aspx?action=pf">
                    <%getPfForm() %>
                </form>
            </div>
          <h2><span class="subTitle">批发管理</span><span class="subBt"><a href="#"></a></span></h2>
            <div class="infoBox">
                <%getPfList()%>
            </div>
    </div>
