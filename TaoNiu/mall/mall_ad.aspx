<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/template/mall.Master" CodeBehind="mall_ad.aspx.vb" Inherits="TaoNiu.mall_ad" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentContent" runat="server">
    <div id="operateArea">
        ...
        <div id="tip"><p>在这儿，您可以对商城的广告浏览管理。</p></div>
        <h2><span class="subTitle">首页广告</span><span class="subBt"><a href="#"></a></span></h2>
        <div class="infoBox">
